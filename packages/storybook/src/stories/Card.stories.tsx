...
import { Card, CardHeader, CardTitle, CardContent, CardFooter, Button } from '@storyhouse/components';
...
export const WithHeaderAndFooter: Story = {
  render: (args) => (
    <Card {...args} style={{ maxWidth: 400 }}>
      ...
      <CardContent>
        <p className="mb-4">
          Welcome to the design system. This card demonstrates how to compose
          cards with headers, content, and footers.
        </p>
        <p className="text-sm text-gray-500">
          Cards are the foundation of our layout system. Use them consistently
